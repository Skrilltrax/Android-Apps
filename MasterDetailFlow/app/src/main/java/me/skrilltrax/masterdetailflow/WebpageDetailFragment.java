package me.skrilltrax.masterdetailflow;
...
import me.skrilltrax.masterdetailflow.dummy.DummyContent;
...
public class WebpageDetailFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (mItem != null) {
            WebView myWebView = rootView.findViewById(R.id.webpage_detail);
